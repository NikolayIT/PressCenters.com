                ...
                List<(string TypeName, string ShortName, string Name, string Description, string Url, string DefaultImageUrl)>
                    {
                        ...
                        ("PressCenters.Services.Sources.BgInstitutions.CiafGovernmentBgSource", "КОНПИ",
                            "Комисия за отнемане на незаконно придобитото имущество",
                            "Комисията за отнемане на незаконно придобитото имущество (КОНПИ) е независим специализиран постоянно действащ държавен орган, който предприема действия по отнемане в полза на държавата на незаконно придобито имущество. Обособена е като самостоятелна институция след разделянето на КПКОНПИ.",
                            "https://ciaf.bg/", "/images/sources/ciaf.government.bg.png"),
