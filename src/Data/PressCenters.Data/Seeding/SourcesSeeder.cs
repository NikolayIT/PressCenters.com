            ...
            var sources = new List<(string TypeName, string ShortName, string Name, string Description, string Url)>
                          {
                              ...
                              ("PressCenters.Services.Sources.BgInstitutions.BasBgSource",
                                  ...
                                  "http://www.bas.bg/"),
                              ("PressCenters.Services.Sources.BgInstitutions.CpdpBgSource",
                                  ...
                                  "https://www.cpdp.bg/"),
                              ("PressCenters.Services.Sources.BgInstitutions.CiafGovernmentBgSource",
                              ...
                              ("PressCenters.Services.Sources.Municipalities.SofiaBgSource",
                                  "СО", "Столична община",
